...
test('checkout makes the discovery source optional and stores it outside customer data when supplied', async () => {
  ...
  assert.match(html, /name="discovery_source" value="google"/)
  assert.doesNotMatch(html, /name="discovery_source" value="google" required/)
  assert.match(html, /id="discovery-help">Optioneel\.<\/p>/)
  ...
  assert.match(edgeFunction, /if \(!source\) return null/)
