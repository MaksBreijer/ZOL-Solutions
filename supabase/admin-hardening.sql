...
insert into public.site_content (page, section, content_key, label, content_type, selector, attribute, value, sort_order) values
  ...
  ('home', 'hero', 'home.hero.video', 'Hero video', 'video', '.hero-media video source', 'src', '/media/zol-hero.mp4', 50),
  ...
  ('home', 'problem', 'home.problem.image', 'Anatomische afbeelding', 'image', '.anatomy-image img', 'src', '/media/heel-anatomy.png', 30),
  ...
  ('home', 'solution', 'home.solution.image', 'Productafbeelding', 'image', '.product-blueprint .product-photo img', 'src', '/media/product-blue.jpg', 20),
  ...
  ('home', 'emotion', 'home.emotion.image', 'Sportfoto', 'image', '.emotion img', 'src', '/media/sport-kids.jpg', 10),
  ...
  ('product', 'gallery', 'product.image.second', 'Productafbeelding 2', 'image', '.product-gallery-secondary img:first-child', 'src', '/media/product-blue.jpg', 20),
  ('product', 'gallery', 'product.image.third', 'Productafbeelding 3', 'image', '.product-gallery-secondary img:last-child', 'src', '/media/product-detail.jpg', 30),
  ...
  ('product', 'usage', 'product.usage.image', 'Gebruiksafbeelding', 'image', '.product-in-use-image img', 'src', '/media/product-use.jpg', 20),
  ...
  ('contact', 'team', 'contact.team.image', 'Teamafbeelding', 'image', '.contact-human-image img', 'src', '/media/contact-team.jpg', 20)
